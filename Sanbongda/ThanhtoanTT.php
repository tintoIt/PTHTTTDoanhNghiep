  <?php
    ...
    && isset($_POST['tensan']) && isset($_POST['thoigianbd']) && isset($_POST['thoigiankt'])
    && isset($_POST['loaisan']) && isset($_POST['ngaydat'])  && isset($_POST['giatien'])  )
      {
          $tenkh = $_POST['tenkh'];
          $sdt = $_POST['sdt'];
          ...
          if (empty($tenkh)) {
            ...
            $sqlselect = "SELECT Tensan, Loaisan FROM danhsachsan where Tensan = '$tensan' and Loaisan = '$loaisan' ";
            $result = mysqli_query($conn, $sqlselect);
            if ($result->num_rows > 0) {
              $sql = "INSERT INTO khachhang values ('$id','$tenkh', '$sdt', '$tensan', '$loaisan', '$ngaydat', '$thoigianbd', '$thoigiankt' ,'$giatien')";
              ...
              $error = 'Không đúng tên sân hoặc loại sân!';
            }
          }
      }
  ?>
      ...
      <form method="POST" action="ThanhtoanTT.php" novalidate>
        <div class="row">
          <div class="col-md-3">
            ...
            <div class =" mb-3">
              <label for="tenkh" class="form-label">Tên đăng nhập</label>
